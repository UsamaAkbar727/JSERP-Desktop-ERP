# PowerShell script to force create the expense_categories table
# Using Node.js sqlite3 wrapper since Python is not available

Write-Host "Creating expense_categories table using Node.js..." -ForegroundColor Cyan
